...
case class IdentityListItem(id: Int, userName: String, starsCount: Int, activeCouponsCount: Int, lastUpdate: Option[Timestamp], isActive: Boolean)
object IdentityListItem {
  implicit val writes: Writes[IdentityListItem] = (
    (JsPath \ "id").write[Int] and
      ...
      (JsPath \ "lastUpdate").write[Option[Timestamp]] and
